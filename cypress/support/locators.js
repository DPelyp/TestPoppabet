...
export class PageElements {
    ...
    birthDay = ':nth-child(3) > .ng-untouched';
    gender = '.form_field > .select-box > .custom_dropdown_reg';
    country = '.begion_tabs > :nth-child(1) > .custom_dropdown_reg';
    city = '.begion_tabs > :nth-child(2) > .custom_dropdown_reg';
    nextButtonSecond = '.next-btn';
    address ='.form_field > .ng-pristine';
    currency = '.select-box > .ng-pristine';
